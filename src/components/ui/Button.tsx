...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses: Record<ButtonVariant, string> = {
    primary: "bg-yellow-500 text-black border-yellow-400 hover:bg-yellow-400", // 원래 상태로 복원
    secondary: "bg-red-500 text-white border-red-600 hover:bg-red-600", // 원래 상태로 복원
    outline: "bg-transparent text-white border-neutral-400 hover:bg-neutral-800 hover:border-white", // 원래 상태로 복원
  };
