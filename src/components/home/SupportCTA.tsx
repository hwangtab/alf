  ...
  return (
    <section className="bg-neutral-800 py-20 px-4"> {/* 배경색 및 패딩 조정 */}
      <div className="container mx-auto text-center">
        <h2 className="text-3xl font-bold mb-6 text-white">우리가 함께한 시간들</h2> {/* 제목 변경 및 텍스트 색상 변경 */}
        <p className="text-lg mb-8 mx-auto text-neutral-300 whitespace-normal"> {/* 텍스트 색상 변경 */}
          예술해방전선의 여정은 수많은 분들의 관심과 연대 덕분에 가능했습니다. 그 뜨거웠던 순간들을 이곳에 기록합니다.
        </p>
