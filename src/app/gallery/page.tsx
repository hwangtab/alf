...
// import GalleryLightbox from './GalleryLightbox'; // 직접 임포트 제거
import altTextsData from '@/data/gallery-alt-texts.json';

// GalleryLightbox를 동적으로 임포트 (클라이언트 측에서만 로드)
const DynamicGalleryLightbox = dynamic(() => import('./GalleryLightbox'), {
  ssr: false, // 서버 측 렌더링 비활성화
  loading: () => <p>라이트박스 로딩 중...</p> // 로딩 상태 표시 (선택 사항)
});
...
export default function GalleryPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-20"> 
      ...
      {/* 동적으로 로드된 GalleryLightbox 사용 */}
      <DynamicGalleryLightbox images={images} />
    </div>
  );
}