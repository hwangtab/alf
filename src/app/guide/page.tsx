      ...
      <main className="flex-1 min-w-0">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              {/* h2에 ID 추가 */}
              <h2 className={h3Style}>{sections[0].title}: 예술, 침묵을 깨고 세상 속으로</h2>
              <p className={pStyle}>
        ...
        >
          {/* h2에 ID 추가 */}
          <h2 className={h2Style}>{sections[1].title}: 낯선 문턱을 넘어, 마음으로 다가가기</h2>
        ...
        >
          {/* h2에 ID 추가 */}
          <h2 className={h2Style}>{sections[2].title}: 연대는 나를 성장시키는 또 다른 작업실</h2>
          <p className={`${pStyle} mb-10`}>
        ...
        >
          {/* h2에 ID 추가 */}
          <h2 className={h2Style}>{sections[3].title}: 예술, 투쟁의 언어가 되고 투쟁, 예술의 영감이 되다</h2>
          <p className={`${pStyle} mb-10`}>
        ...
        >
          {/* h2에 ID 추가 */}
          <h2 className={h2Style}>{sections[4].title}: 목소리 없는 이들의 목소리가 되어</h2>
          <p className={`${pStyle} mb-10`}>
        ...
        >
          {/* h2에 ID 추가 */}
          <h2 className={h2Style}>{sections[5].title}: 위계 없이 자유롭게, 서로 도우며 함께 성장하기</h2>
          <p className={`${pStyle} mb-10`}>
        ...
        >
          {/* h2에 ID 추가 */}
          <h2 className={h2Style}>{sections[6].title}: 홀로 외롭지 않게, 함께 멀리 가기 위하여</h2>
          <p className={`${pStyle} mb-10`}>
        ...
        >
          {/* h2에 ID 추가 */}
          <h2 className={h3Style}>{sections[7].title}: 예술과 투쟁의 경계에서, 당신의 자리를 찾아서</h2>
          <p className={`${pStyle} mb-10`}>
