...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: '회원 가입 | 예술해방전선',
    description: '예술해방전선 정기 회원이 되어 예술로 저항하고 연대하는 활동을 함께 만들어 가세요.',
    url: 'https://alf.seoul.kr/support',
    siteName: '예술해방전선',
    locale: 'ko_KR',
    type: 'website',
    images: [{ url: '/images/social-thumbnail.webp', width: 1200, height: 630, alt: '예술해방전선 회원 가입' }],
  },
  twitter: {
    ...
    <div className="container mx-auto pt-28 pb-20 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-12">
          {[
            { icon: '💳', title: '정기 자동이체', desc: '매월 지정한 날짜에 CMS 자동이체로 회비가 출금됩니다.' },
            { icon: '📬', title: '활동 보고 수신', desc: '매달 예술해방전선의 활동 보고 뉴스레터를 받으실 수 있습니다.' },
            { icon: '✊', title: '연대', desc: '정기 회원이 되어 예술로 저항하고 소외된 이들과 연대하는 활동의 일원이 됩니다.' },
          ].map((item) => (
        ...
        <div className="bg-neutral-900/60 border border-neutral-700 rounded-2xl p-6 md:p-8">
          <h2 className="text-2xl font-bold text-white mb-1">정기 회원 가입 신청</h2>
