...
export default function AboutPage() {
  ...
  return (
    <div className="container mx-auto pt-28 pb-20 px-4">
      ...
      >
        <h1 className="text-5xl font-bold mb-6 text-white bg-clip-text text-transparent bg-gradient-to-r from-yellow-500 to-red-600 font-giants-inline">예술해방전선</h1>
