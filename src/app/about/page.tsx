  ...
  return (
    <div className="container mx-auto pt-28 pb-20 px-4">
      ...
      <motion.section
        ...
        variants={fadeIn}
      >
        <h2 className="text-3xl font-bold mb-8 text-white font-test-serif">
          우리의 시작: 새벽의 외침, 연대의 불씨
        </h2>
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="mb-4 text-neutral-300 leading-relaxed text-lg font-test-sans">
            ...
            <p className="text-neutral-300 leading-relaxed text-lg font-test-sans">
      ...
      <motion.section
        ...
        variants={fadeIn}
      >
        <h2 className="text-3xl font-bold mb-8 text-white font-test-serif">우리가 꿈꾸는 세상</h2>
        <div>
          <p className="text-neutral-300 leading-relaxed text-lg mb-6 font-test-sans">
      ...
      >
        <div className="bg-neutral-800 rounded-xl p-8 shadow-lg">
          ...
          <div className="relative">
            {/* 세로선 - 데스크톱: 중앙, 모바일: 왼쪽 */}
            <div className="absolute md:left-1/2 left-6 md:transform md:-translate-x-1/2 h-full w-0.5 bg-gradient-to-b from-yellow-500 via-red-500 via-orange-500 to-amber-500"></div>
            ...
            <div className="space-y-8 md:space-y-12">
                ...
                <div className="w-full md:w-1/2 md:pr-8 md:text-right pl-16 md:pl-0">
                  <div className="bg-gradient-to-r from-yellow-500/20 to-yellow-600/20 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-yellow-500/30 hover:border-yellow-400/50 transition-all duration-300 hover:shadow-lg hover:shadow-yellow-500/10">
                    <div className="flex items-center md:justify-end mb-4">
                      ...
                      <h3 className="text-lg md:text-xl font-bold text-white font-test-serif ml-3 md:ml-0 md:mr-3 md:order-1">함께 걷는 길, 연대</h3>
                    </div>
                    <p className="text-neutral-300 leading-relaxed font-test-sans text-sm">
                      우리는 결코 홀로 서지 않습니다. 노량진 수산시장, 동서울 터미널 등 삶의 터전에서 밀려나고 억압받는 사회적 약자들과 소외된 이들의 곁을 묵묵히 지키고 있습니다. 연대는 우리의 가장 따뜻한 무기입니다.
                    </p>
                  </div>
                </div>
                {/* 중앙 포인트 - 모바일: 왼쪽, 데스크톱: 중앙 */}
                <div className="absolute md:left-1/2 left-6 md:transform md:-translate-x-1/2 w-3 h-3 md:w-4 md:h-4 bg-yellow-500 rounded-full border-2 md:border-4 border-neutral-800 z-10 -translate-x-1/2"></div>
                {/* 데스크톱에서만 보이는 빈 공간 */}
              ...
              <motion.div variants={fadeIn} className="flex items-center">
                ...
                <div className="hidden md:block md:w-1/2"></div>
                {/* 중앙 포인트 */}
                <div className="absolute md:left-1/2 left-6 md:transform md:-translate-x-1/2 w-3 h-3 md:w-4 md:h-4 bg-red-500 rounded-full border-2 md:border-4 border-neutral-800 z-10 -translate-x-1/2"></div>
                <div className="w-full md:w-1/2 md:pl-8 pl-16 md:pl-8">
                  <div className="bg-gradient-to-r from-red-500/20 to-red-600/20 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-red-500/30 hover:border-red-400/50 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/10">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-lg md:text-xl font-bold text-white font-test-serif">침묵하지 않는 목소리, 저항</h3>
                    </div>
                    <p className="text-neutral-300 leading-relaxed font-test-sans text-sm">
              ...
              <motion.div variants={fadeIn} className="flex items-center">
                <div className="w-full md:w-1/2 md:pr-8 md:text-right pl-16 md:pl-0">
                  <div className="bg-gradient-to-r from-orange-500/20 to-orange-600/20 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-orange-500/30 hover:border-orange-400/50 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/10">
                    <div className="flex items-center md:justify-end mb-4">
                      ...
                      <h3 className="text-lg md:text-xl font-bold text-white font-test-serif ml-3 md:ml-0 md:mr-3 md:order-1">새로운 길을 찾는 용기, 실험</h3>
                    </div>
                    <p className="text-neutral-300 leading-relaxed font-test-sans text-sm">
                ...
                {/* 중앙 포인트 */}
                <div className="absolute md:left-1/2 left-6 md:transform md:-translate-x-1/2 w-3 h-3 md:w-4 md:h-4 bg-orange-500 rounded-full border-2 md:border-4 border-neutral-800 z-10 -translate-x-1/2"></div>
                <div className="hidden md:block md:w-1/2"></div>
              </motion.div>
              ...
              <motion.div variants={fadeIn} className="flex items-center mb-8">
                <div className="hidden md:block md:w-1/2"></div>
                {/* 중앙 포인트 */}
                <div className="absolute md:left-1/2 left-6 md:transform md:-translate-x-1/2 w-3 h-3 md:w-4 md:h-4 bg-amber-500 rounded-full border-2 md:border-4 border-neutral-800 z-10 -translate-x-1/2"></div>
                <div className="w-full md:w-1/2 md:pl-8 pl-16 md:pl-8">
                  <div className="bg-gradient-to-r from-amber-500/20 to-amber-600/20 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-amber-500/30 hover:border-amber-400/50 transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/10">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-lg md:text-xl font-bold text-white font-test-serif">다름을 안는 마음, 포용</h3>
                    </div>
                    <p className="text-neutral-300 leading-relaxed font-test-sans text-sm">
