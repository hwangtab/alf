...
export default function AboutPage() {
  ...
  return (
    <div className="container mx-auto py-20 px-4">
      ...
      >
        <h1 className="text-5xl font-bold mb-6 text-white bg-clip-text text-transparent bg-gradient-to-r from-yellow-500 to-red-600">예술해방전선</h1>
          ...
          <div>
            <p className="mb-4 text-neutral-300 leading-relaxed text-lg">
             ...
             <p className="text-neutral-300 leading-relaxed text-lg">
              억압받는 이들의 곁에서 우리는 함께 노래하고, 그리고, 그들의 이야기를 우리의 작품 속에 소중히 기록하며 연대하고 있습니다. 이곳은 바로 그 뜨겁고 치열한 시간들의 기록이자, 깊은 절망 속에서도 끝끝내 피워 올리는 희망의 노래입니다. 우리의 활동은 계속되고 있으며, 예술을 통해 세상을 바꾸고자 하는 연대의 정신은 이곳 아카이브에 영원히 살아 숨 쉬며, 또 다른 누군가에게 작은 용기와 깊은 영감이 되기를 간절히 소망합니다.
            </p>
          </div>
